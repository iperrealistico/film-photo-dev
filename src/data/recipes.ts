    ...
    inputs: [
      {
        ...
        helperText:
          'Choose the exact film family from the official Df96 chart. Different films can change the valid rating bands, minimum monobath multipliers, 3200-film handling, and any stock-specific warnings.',
